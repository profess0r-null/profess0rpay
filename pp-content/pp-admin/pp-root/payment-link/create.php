...
if (!defined('Profess0rPay_INIT')) {
    ...
    $is_temp_mode = isset($params['type']) && $params['type'] == 'temp';
?>
            ...
            <!-- Page pre-title -->
                <div class="page-pretitle">
                    <ol class="breadcrumb breadcrumb-arrow mb-0">
                        ...
                        <li class="breadcrumb-item active"><a href="javascript:void(0)"><?php echo $is_temp_mode ? 'Create Temp Link' : 'Create Payment Link'; ?></a></li>
                    </ol>
                </div>
                <h2 class="page-title"><?php echo $is_temp_mode ? 'Create Temp Link' : 'Create Payment Link'; ?></h2>
            </div>
        </div>
    </div>
</div>
    ...
    <div class="container-xl">
        <div class="row g-gs">
            <div class="col-12 col-xxl-12">
                <form class="form-paymentLink-create" enctype="multipart/form-data">
                                ...
                                <div class="card-body">
                                    <div class="row g-3">
                                        ...
                                        <div class="col-lg-4">
                                            <div class="d-flex justify-content-between align-items-center mb-1">
                                                ...
                                                <div class="custom-control custom-checkbox custom-control-sm">
                                                    <input type="checkbox" class="custom-control-input" id="limitQuantity" onchange="toggleQuantityInput(this)">
                                                    <label class="custom-control-label" for="limitQuantity">Limit Quantity</label>
                                                </div>
                                            </div>
                                            <div class="input-group">
                                                <input type="number" class="form-control" name="quantity" id="quantityInput" placeholder="Unlimited" disabled value="">
                                            </div>
                                            <script>
                                        ...
                                        <div class="col-lg-12">
                                            ...
                                            <div class="input-group">
                                                <input type="text" name="return_url" class="form-control" placeholder="https://yourwebsite.com/success">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-3">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control invoice-amount" name="amount" aria-label="Amount (to the nearest dollar)" placeholder="0" required="">
                                            </div>
                                        </div>
                                                        ...
                                                        <?php
                                                            ...
                                                            if ($response_gateway['status'] == true) {
                                                                foreach ($response_gateway['response'] as $gw) {
                                                                    echo '<option value="' . $gw['gateway_id'] . '">' . htmlspecialchars($gw['display'] ?? $gw['name']) . '</option>';
                                                                }
                                                            }
                                                        ?>
                                                    </select>
