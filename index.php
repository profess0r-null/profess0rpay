                            ...
                            if($response_brand['status'] == true){
                                ...
                                if(file_exists(__DIR__.'/pp-content/pp-modules/pp-gateways/'.$response_gateway['response'][0]['slug'].'/class.php')){
                                    ...
                                    $brandInfo = [
                                        ...
                                        'redirect_url' => $brandRow['redirect_url'] ?? '',
                                    ];
                            ...
                            if($response_brand['status'] == true){
                                if(file_exists(__DIR__.'/pp-content/pp-modules/pp-themes/'.$response_brand['response'][0]['theme'].'/class.php')){
                                    ...
                                    $transactionInfo = [
                                        ...
                                        'return_url'          => $finalUrl,
                                        'raw_return_url'      => $transactionRow['return_url'] ?? '--', // raw value before status-based masking
                                        'gateway_id'          => $transactionRow['gateway_id'] ?? '',
                                        'brand_id'            => $transactionRow['brand_id'],
