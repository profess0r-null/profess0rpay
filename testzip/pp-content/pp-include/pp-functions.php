        ...
        if($response_gateway['status'] == true){
            ...
            if ($response_gateway['response'][0]['tab'] == 'mfs') {
                ...
                if (strpos(strtolower($slug), 'bkash') !== false) {
                    ...
                    $cartBg = '#f1f5f9';
                    $cartColor = '#64748b';
                    $g_logo = rtrim(pp_site_address(), '/') . '/assets/images/bkash_english.jpg';
                ...
                if ($verification_method === 'number_amount') {
                    ...
                    <div id="zini-step1">
                        <div class="zini-pink-body zini-step1-body">
                            ...
                            ' : '
                            <div class="zini-step1-terms" style="margin-top: 14px; font-size: 13px; line-height: 1.4; font-weight: 700;">Confirm and proceed, <a href="#" style="text-decoration: underline; text-underline-offset: 2px;">terms & conditions</a></div>
                            ').'
                        </div>
